...
Continued LoRA training on retain answers moves the forget and retain output distributions together: RII drops to $9.73{\times}10^{-2}$, a $16\%$ decrease. It also attains the lowest MIA (0.852), meaning the model remains most fluent on the forget set. This matches the vision results. As in Section~\ref{sec:rebound}, however, a reduced RII is not sufficient for true erasure, because forget accuracy remains 100\%.
